...
import {useCurrentUser} from "@/domain/shared/hooks/useCurrentUser";
import {SettingsSchema} from "@/domain/auth/schema/setting.schema";
import {settingAccount} from "@/domain/auth/usecases/settingAccount";
...
import Toggle from "@/presentation/shared/components/Toggle/Toggle";
...
const SettingForm= () => {
    ...
    const onSubmit = (values: z.infer<typeof SettingsSchema>) => {
        startTransition(() => {
            new settingAccount().execute(values)
                .then((data:any) => {
                    if (data.error) {
